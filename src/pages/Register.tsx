      ...
      <div className="relative w-full max-w-md">
        <div className="glass-card rounded-3xl p-8">
          <div className="mb-8 text-center">
            ...
            <p className="mt-1.5 text-sm text-muted-foreground">Join CivicFix and start reporting issues</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="name" placeholder="John Doe" className="h-11 rounded-xl border-border/60 bg-muted/30 pl-9 focus:bg-card" value={name} onChange={e => setName(e.target.value)} required />
              </div>
            </div>
            <div className="space-y-2">
